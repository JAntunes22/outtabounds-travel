  ...
  const getItemDetails = (item, type) => {
    ...
    if (itemDetails) {
      ...
      if (!itemDetails.imageUrl) {
        if (type === 'course' && itemDetails.url) {
          // For courses, use the url field
          itemDetails.imageUrl = itemDetails.url;
          console.log(`Using 'url' field for course:`, itemDetails.url);
          ...
          itemDetails.imageUrl = "https://via.placeholder.com/300x200?text=No+Image+Available";
        }
      }
      return itemDetails;
    }
                  ...
                  <div className="includes-vertical-section">
                    ...
                    <div className="includes-items-list">
                      {pack.accommodations.map((accommodation, index) => {
                        ...
                        const imageSrc = accommodationDetails.imageUrl || "https://via.placeholder.com/300x200?text=No+Image+Available";
                  ...
                  <div className="includes-vertical-section">
                    ...
                    <div className="includes-items-list">
                      {pack.courses.map((course, index) => {
                        ...
                        const imageSrc = courseDetails.imageUrl || courseDetails.url || "https://via.placeholder.com/300x200?text=No+Image+Available";
                  ...
                  <div className="includes-vertical-section">
                    ...
                    <div className="includes-items-list">
                      {pack.experiences.map((experience, index) => {
                        ...
                        // Ensure we check for all possible image fields
                        const hasImage = !!experienceDetails.imageUrl;
                        const imageSrc = experienceDetails.imageUrl || "https://via.placeholder.com/300x200?text=No+Image+Available";
